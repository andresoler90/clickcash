...
class CreateLegacyRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('legacy_payment_requests', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('legacy_payment_request');
    }
}
