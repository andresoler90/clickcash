        ...
        <div class="row no-gutters">
            <div class="col-sm-6 align-self-center">
                <div class="sign-in-from">
                    ...
                    <p>{{__('Ingresa con tu usuario para acceder al panel de administrador')}}</p>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-4">
                        ...
                        <div class="form-group">
                            ...
                            <input id="username" type="text"
                                   class="form-control  mb-0 @error('username') is-invalid @enderror" placeholder="Ingrese con su usuario"
                        ...
                        <div class="form-group">
                            ...
                            <a href="#" class="float-right">{{__('¿Olvidaste tu clave?')}}</a>
