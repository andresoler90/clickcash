                ...
                <td style="text-align: center">
                    @if(Storage::exists($path))
                        <a href="#" data-toggle="modal"
                           data-target=".documentKycModal{{$kyc->id}}">
                            <i class="fa fa-file-pdf-o" style="color: green">
                            </i>
                        </a>
                        @include('cruds.kycs.partials.document_modal')
                    @else
{{--                        <a><i class="fa fa-file-pdf-o" style="color: grey"></i>{{ __(' Sin documento') }}</a>--}}
                    @endif
                </td>
                <td>
