...
@section('content')
    ...
    <div id="content-page" class="content-page">
        <div class="container-fluid">
            ...
            @if(count($payments) || count($legacyPayments))
                <div class="row">
                    <div class="col-md-12">
                        <div class="iq-card">
                            <div class="iq-card-body">
                                <ul class="nav nav-tabs" id="myTab-1" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#legacy-tab"
                                           role="tab" aria-selected="true">
                                            {{__("Legacy")}}
                                            <span class="badge badge-default">{{count($legacyPayments)}}</span>
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="legacy-tab" role="tabpanel">
                                        @include("cruds.payment.partials.list",["route"=>'legacy.payment.action',"legacy"=>true,"payments"=>$legacyPayments])
                                    </div>
                                </div>
                            </div>
                        </div>
